...
6. **Create OAuth app in Linear:**
   ...
   - Name: your agent's display name (e.g. `Hanzo (Merge Gate)`)
...
9. **Verify the success page shows the agent's name** (e.g. `Hanzo (Merge Gate)`). If it shows your personal name, you authorized as a user — redo step 8 with `actor=app`.
...
⚠️ **The response must show the agent's name** (e.g. `{"name": "Hanzo (Merge Gate)"}`). If it shows your personal name (e.g. "Matt Henry"), you authorized as a personal user, not as an app. Go back to Step 2.
