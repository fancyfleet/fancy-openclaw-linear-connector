 ...
 */
export declare function defStateSnapshotPath(): string;
/**
 ...
 */
export declare function readDefStateSnapshot(): Promise<DefStateSnapshot>;
/**
 ...
 */
export declare function writeDefStateSnapshot(snapshot: DefStateSnapshot): Promise<void>;
//# sourceMappingURL=def-state-snapshot-store.d.ts.map