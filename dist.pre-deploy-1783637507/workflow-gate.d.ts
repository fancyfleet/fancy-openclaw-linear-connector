...
export declare function checkWorkflowRules(intent: string, issueId: string | null, authToken: string, bodyId: string, target?: string | null, callerLinearUserId?: string | null, artifactRef?: string | null, breakGlassOverride?: boolean, isMetaIntent?: boolean, hasComment?: boolean, snapshotDelegateId?: string | null): Promise<string | null>;
/**
