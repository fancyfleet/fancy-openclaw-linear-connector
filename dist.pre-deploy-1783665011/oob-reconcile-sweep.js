 ...
 * operational events.
 */
export async function reconcileOobMutations(store, opts) {
    ...
    const changeTypes = ["state", "delegate", "label"];
    ...
    for (const webhookRec of uncorrelated) {
        ...
        const candidates = store.findProxyCandidates(webhookRec.ticket, webhookRec.changeType, matchSince, matchUntil, webhookRec.ticketUuid);
 ...
 */
export function registerOobReconcileCron(store, operationalEventStore, intervalMs) {
...
//# sourceMappingURL=oob-reconcile-sweep.js.map