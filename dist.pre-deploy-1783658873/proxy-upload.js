...
function assertLinearHost(url) {
    ...
    if (host !== "linear.app" && !host.endsWith(".linear.app")) {
        throw new Error(`Refusing to fetch a non-Linear host (${host}). Only uploads.linear.app / *.linear.app URLs are accepted.`);
    }
    return parsed;
}
...
export async function handleProxyUploadRequest(req, res) {
...
//# sourceMappingURL=proxy-upload.js.map