 ...
 */
export declare function getWorkflowRegistryLiveness(): Promise<Record<string, {
 ...
 */
export declare function validateFanoutBarrierConfig(def: WorkflowDef): string[];
 ...
 */
export declare function resolveTransitionDelegate(toStateName: string, matchedTransition: WorkflowTransition | undefined, def: WorkflowDef, issueId: string, cliTarget?: string): Promise<string | null | undefined>;
 ...
 */
export declare function resolveMetaIntent(intent: string, issueId: string, authToken: string, snapshotState?: string | null): Promise<{
    resolved: string;
} | {
    error: string;
}>;
 ...
 */
export declare function cliVerbFor(t: {
    command: string;
    generic?: string;
}): string;
/**
 ...
 */
export declare function verifyCommentSatisfiedBy(issueId: string, commentId: string, authToken: string, callerLinearUserId?: string | null): Promise<boolean>;
export declare function checkWorkflowRules(intent: string, issueId: string | null, authToken: string, bodyId: string, target?: string | null, callerLinearUserId?: string | null, artifactRef?: string | null, breakGlassOverride?: boolean, isMetaIntent?: boolean, hasComment?: boolean, snapshotDelegateId?: string | null, snapshotState?: string | null): Promise<string | null>;
/**
...
export declare function applyStateTransition(intent: string, issueId: string | null, authToken: string, options?: ApplyStateTransitionOptions): Promise<TransitionApplyResult>;
/**
...
export declare function _setTransitionWritePolicyForTests(policy?: Partial<TransitionWritePolicy>): void;
/**
 ...
 */
export declare function fetchTicketVerification(issueId: string, authToken: string): Promise<{
    labels: string[];
