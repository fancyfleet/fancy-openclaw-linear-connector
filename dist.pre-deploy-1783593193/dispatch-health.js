 ...
 */
export function computeDispatchHealth(events, ackEntry, options) {
    ...
    const recentEngagement = sorted.find((e) => ENGAGEMENT_OUTCOMES.has(e.outcome) && now - new Date(e.occurredAt).getTime() <= workingThresholdMs);
    if (recentEngagement) {
 ...
 */
export function batchComputeDispatchHealth(ticketKeys, ackEntriesByTicket, options) {
...
//# sourceMappingURL=dispatch-health.js.map