 ...
 */
export function universalPolicyPath() {
    return (process.env.UNIVERSAL_POLICY_PATH ??
 ...
 */
export function parseCanonFile(content) {
 ...
 */
export async function loadUniversalCanon() {
    ...
    try {
        ...
        log.warn(`universal-canon: could not load canon file at ${filePath} — dispatch will proceed without canon section. Reason: ${reason}`);
        activeCanon = null;
        return null;
    }
}
 ...
 */
export function getActiveCanonVersion() {
 ...
 */
export function formatCanonBlock(canonText, version) {
...
export function _resetCanonForTest() {
    activeCanon = null;
}
//# sourceMappingURL=universal-canon.js.map