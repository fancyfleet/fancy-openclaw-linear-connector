...
export const OPERATIONAL_EVENT_OUTCOMES = ["received", "signature-rejected", "duplicate", "normalized", "terminal-pruned", "dead-letter", "no-route", "no-route-human", "routed", "dedup-suppressed", "bag-added", "delivered", "delivery-pending-ack", "dispatch-accepted", "dispatched", "queued", "delivery-failed", "delivery-unconfirmed", "session-ended", "stale-resignaled", "startup-replayed", "startup-pruned", "no-activity-warn", "no-activity-failed", "deferred-at-capacity", "deferred-capacity-rearm", "stuck-delegate-reprompt", "stale-c4-repoke", "stale-c4-repoke-failed", "stale-c4-repoke-dropped", "phantom-dispatch-abort", "stale-snapshot-mutation-rejected", "engagement-thinking", "engagement-doing", "engagement-todo", "bootstrap-bootstrapped", "bootstrap-demoted", "bootstrap-rejected", "bootstrap-wake-dispatched", "bootstrap-wake-delivered", "bootstrap-wake-failed", "enrollment-healed", "break-glass-used", "hold-retry-dispatch", "no-activity-redispatch", "no-activity-redispatch-failed", "delegation-reconciled", "delegation-reconciliation-failed", "watchdog-resignal", "comment-post-failed", "def-state-migrated", "def-state-migration-failed", "state-rewound", "fixture-drift-non-green", "suppressed-duplicate", "dropped-stale", "transition-write-failed", "dispatch-undeliverable", "observation-recorded", "observation-skipped", "rescue:rescued", "rescue:ambiguous", "rescue:failed", "auto-enrolled", "stale-plain-delegate-redispatch", "stale-plain-delegate-redispatch-failed", "stale-delegate-escalated", "ping-pong-cycle-detected", "ping-pong-exempt-terminal-target", "watchdog-escalation", "watchdog-drop-unresolvable", "watchdog-delegate-mismatch", "watchdog-skip-no-workflow", "wake-turn-failed", "commitment-exit-recorded", "failure-taxonomy", "xfn-demoted", "dependency-clear-wake", "dependency-clear-failed"] as const;
...
const ERROR_OUTCOMES = new Set<OperationalEventOutcome>(["signature-rejected", "delivery-failed", "no-route", "no-activity-warn", "no-activity-failed", "deferred-at-capacity", "dispatch-undeliverable", "wake-turn-failed"]);
