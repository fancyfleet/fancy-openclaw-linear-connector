...
const DEFAULT_TEMPLATE = "You have {count} pending ticket(s) waiting: {tickets}. Run `linear my-next` to pick up the highest-priority one, or `linear queue` to see all.";
/**
