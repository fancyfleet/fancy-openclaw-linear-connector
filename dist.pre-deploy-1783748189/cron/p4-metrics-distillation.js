...
import { generateProposals, } from "../proposal/proposal-generator.js";
 ...
 */
export function createProdGenerationContext() {
    return {
 ...
 */
export async function runDistillation(observationStore, proposalStore, ctx, options) {
    ...
    try {
        ...
        log.info(`[P4-C3] Found ${crossedPatterns.length} crossed pattern(s)` +
        ...
        const clusters = proposable.map((item) => ({
 ...
 */
export function registerDistillationCron(observationStore, proposalStore, ctx) {
