...
export declare function formatIntervalMs(ms: number): string;
/**
 ...
 */
export declare function registerCron(name: string, schedule: string): void;
/**
 ...
 */
export declare function markCronRun(name: string, now?: Date): void;
/** All drivers registered in this process, sorted by name. */
export declare function getRegisteredCrons(): CronRegistryEntry[];
/** Test-only: clear the registry between cases. */
export declare function resetCronRegistryForTest(): void;
