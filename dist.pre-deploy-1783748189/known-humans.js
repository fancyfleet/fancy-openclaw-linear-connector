...
export function knownHumansPath() {
    return (process.env.KNOWN_HUMANS_PATH ??
        path.join(instanceConfigRoot(), "config", "known-humans.yaml"));
}
const EMPTY = new Map();
let cache = null;
/** Test hook: drop the mtime-keyed cache. */
export function resetKnownHumansCache() {
    cache = null;
}
/**
 ...
 */
export function loadKnownHumans() {
...
export function knownHumanName(linearUserId) {
    return loadKnownHumans().get(linearUserId) ?? null;
}
//# sourceMappingURL=known-humans.js.map