 ...
 */
export declare const REASON_CODES: readonly ["missing-tests", "style", "scope-creep", "correctness", "ac-mismatch", "unclassified"];
/** The fallback used when no category is supplied by header or comment. */
export declare const UNCLASSIFIED_REASON_CODE = "unclassified";
